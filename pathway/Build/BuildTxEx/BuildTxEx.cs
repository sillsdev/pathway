// --------------------------------------------------------------------------------------------
// <copyright file="BuildTxEx.cs" from='2009' to='2009' company='SIL International'>
...
namespace BuildTxEx
{
    public partial class BuildTxEx : Form
    {
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the BuildTxEx class.
        /// </summary>
        public BuildTxEx()
        {
            InitializeComponent();
        ...
        /// </summary>
        private void BuildTxEx_Load(object sender, EventArgs e)
        {
            var args = Environment.GetCommandLineArgs();
            if (args.Length < 2 || args[1] != "PwTxEx")
            {
                Close();
                Environment.Exit(0);
            }
            ...
            const string Readme = "ReadMeTxEx.rtf";
            ...
            sub.FileSubstitute("FeaturesTxEx-tpl.wxs", map, "Features.wxs");
            ...
            SubProcess.Run(instPath, "BuildInstallerTxEx.bat");
            ...
            else
            {
                ...
                if (File.Exists(target))
                    File.Delete(target);
                File.Move(instPath + "SetupTxEx.msi", target);

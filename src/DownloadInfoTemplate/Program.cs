...
namespace DownloadInfoTemplate
{
	internal class Program
	{
		...
		private static string GetName(string fileName)
		{
			...
			fileName = Path.GetFileNameWithoutExtension(fileName).Replace("-", " ").Replace("_"," ").Replace(" amd64"," 64-bit").Replace(" i386"," 32-bit").Replace(" all","").Replace("Test","").Replace("Setup","").Replace("BTE"," Translation Edition").Replace("SE"," Standard Edition");

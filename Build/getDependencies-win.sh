...
#     paths: {"L10NSharp.dll"=>"lib", "L10NSharp.pdb"=>"lib", "SIL.Core.dll"=>"lib", "SIL.Core.pdb"=>"lib", "SIL.WritingSystems.dll"=>"lib", "SIL.WritingSystems.pdb"=>"lib", "icu.net.dll"=>"lib", "icudt54.dll"=>"lib", "icuin54.dll"=>"lib", "icuuc54.dll"=>"lib"}
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt223/pathway.tcbuildtag/spart.dll ../lib/spart.dll

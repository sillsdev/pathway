    ...
    public class SettingsValidator
    {
        ...
        protected void CopySettingsFile(string fileName, string supportPath, string filePath)
        {
            ...
            if (errorTag.IndexOf("|") > 0)
            {
                ...
                msg = LocalizationManager.GetString("ConfigurationToolBL.CopySettingsFile.Message1",
            ...
            {
                msg = LocalizationManager.GetString("ConfigurationToolBL.CopySettingsFile.Message2",

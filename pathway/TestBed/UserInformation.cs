    ...
    public class UserInformation
    {
        public void GetUserInformation()
        {
            try
            {
                ...
                string systemCountry = string.Empty; //45
                ...
                oSNameVersion = GetOsNameVersion();
            ...
            string IndesignVersion, string WeSay, string Bloom, string FontLists, string BrowserList, string SystemCountry, string GeoLocation, string Language, string FrameworkVersion)
        {
            ...
            string uri = "http://myphpapps.com.cws10.my-hosting-panel.com/configdb.php" + "?UserSystemGuid=" +
                         ...
                         PathwayVersion + "&JavaVersion=" + JavaVersion + "&ParatextVersion=" + ParatextVersion + "&TEVersion=" + TEVersion + "&LibraofficeVersion=" + LibraofficeVersion +
                         "&Prince=" + Prince + "&XelatexVersion=" + XelatexVersion + "&IndesignVersion=" + IndesignVersion + "&WeSay=" + WeSay +
                         "&Bloom=" + Bloom + "&FontLists=" + FontLists + "&BrowserList=" + BrowserList + "&SystemCountry=" + SystemCountry + "&GeoLocation=" + GeoLocation +

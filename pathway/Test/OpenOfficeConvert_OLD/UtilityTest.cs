...
namespace Test.zOld_OpenOfficeConvert
{
    ...
    public class UtilityTest
    {
        ...
        protected void SetUp()
        {
            ...
            _inputPath = PathPart.Bin(Environment.CurrentDirectory,"/OpenOfficeConvert_OLD/TestFiles/input");
            _outputPath = PathPart.Bin(Environment.CurrentDirectory, "/OpenOfficeConvert_OLD/TestFiles/output");
            _expectedPath = PathPart.Bin(Environment.CurrentDirectory, "/OpenOfficeConvert_OLD/TestFiles/expected");

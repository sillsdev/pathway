// --------------------------------------------------------------------------------------------
// <copyright file="SetVersionSE.cs" from='2009' to='2009' company='SIL International'>
...
namespace Builder
{
    public partial class SetVersionSE : Form
    {
        #region variables
        /// <summary>
        ...
        /// </summary>
        private const string ProdName = @"Pathway SE ";
        #endregion variables

        #region Constructor
        /// <summary>
        /// Initializes a new instance of the SetVersionSE class.
        /// </summary>
        public SetVersionSE()
        {
            InitializeComponent();
        ...
        private void Builder_Load(object sender, EventArgs e)
        {
            ...
            if (args.Length < 2 || args[1] != "ReleaseSE")
            {
                Close();
                Environment.Exit(0);
            }
        ...
        private void Notes_Click(object sender, EventArgs e)
        {
            ...
            BuilderBL.UpdateInstallerDescription(instPath, "pathwaySE.wxs", Version.Text);

    ...
    public class PsExportTest : SIL.PublishingSolution.PsExport
    {
        ...
        public void T15DictionaryRights()
        {
            var tests = new ArrayList
            {
                ...
                new ODet(ODet.Chk, "rights url", ODet.Main, ODet.Content, "//text:span[starts-with(@text:style-name, 'span_LText')][2]", "http://www.ethnologue.com/show_language.asp?code=auc"),

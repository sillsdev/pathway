...
#region OS-specific stuff
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public static DialogResult MsgBox(string message, string msg)
		{
		...
		{
			return MessageBox.Show(msg, String.Empty, MessageBoxButtons.OK, icon);
		}
		...
		public static DialogResult MsgBox(string msg, MessageBoxButtons buttons)
		{
			...
			return MessageBox.Show(msg, String.Empty, buttons, icon);
		}
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public static DialogResult MsgBox(string msg, string title, MessageBoxButtons buttons, MessageBoxIcon icon)
		{
			if (SuppressMsgBoxInteractions)
				return DialogResult.None;

			s_msgBoxJustShown = true;
			msg = MappingButtonText(msg);
			if (title.Length == 0)
				title = Application.ProductName;
			title = LocalizationManager.GetString("CustomMessageBox.Title", title);
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public static DialogResult MsgBox(string msg, string title, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton button)
		{
			if (SuppressMsgBoxInteractions)
				return DialogResult.None;
			...
			if (title.Length == 0)
				title = Application.ProductName;
			title = LocalizationManager.GetString("CustomMessageBox.Title", title);
			return MessageBox.Show(msg, title, buttons, icon, button);
		}

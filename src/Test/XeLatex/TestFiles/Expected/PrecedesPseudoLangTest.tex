...
\headwordfirstoftypearticledictionary{want}\grammarrequiresfirstoftypearticledictionary{obj}\relationsynonymfirstoftypearticledictionary{desire}\pronunciationenUKarticledictionary{wʌnt}\pronunciationenUSarticledictionary{ Hai}\pronunciationenUSarticledictionary{wɑːnt}\pronunciationenUKarticledictionary{ Hello}\pronunciationenUKarticledictionary{wɑːnt}\grammarcategoryfirstoftypearticledictionary{v}\definitionfirstoftypearticledictionary{to desire a particular thing or plan of action}\notefirstoftypearticledictionary{Want is not used in polite requests in British English.}\exampleusearticledictionary{T}\examplearticledictionary{I want some chocolate.}\exampleusearticledictionary{T}\examplearticledictionary{She wants a word with you.}

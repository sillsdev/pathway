...
\topskip 18pt{\baselineskip 18pt{\letterletHeaddicBody{అ}}}
 \label{PageStock_GautamiFontTest1} \end{center}
\end{spacing}\setlength{\columnsep}{12pt} 
\setlength\columnseprule{0.4pt} 
\begin{multicols}{2}\begin{spacing}{0.458333333333333}{\raggedright} \begin{adjustwidth}{1pt}{0pt}{2pt}{9pt}\begin{spacing}{0.458333333333333}\leftskip 12pt \parindent -12pt 
...
\end{spacing}\end{adjustwidth}  \end{spacing}\end{multicols}
\end{document}

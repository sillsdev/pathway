// --------------------------------------------------------------------------------------------
// <copyright file="SetVersionBTE.cs" from='2009' to='2009' company='SIL International'>
...
namespace Builder
{
    public partial class SetVersionBTE : Form
    {
        #region variables
        /// <summary>
        ...
        /// </summary>
        private const string ProdName = @"Pathway BTE ";
        #endregion variables

        #region Constructor
        /// <summary>
        /// Initializes a new instance of the SetVersionBTE class.
        /// </summary>
        public SetVersionBTE()
        {
            InitializeComponent();
        }
        ...
        private void Builder_Load(object sender, EventArgs e)
        {
            ...
            if (args.Length < 2 || args[1] != "ReleaseBTE")
            {
                Close();
                Environment.Exit(0);
            }
        ...
        private void Notes_Click(object sender, EventArgs e)
        {
            ...
            BuilderBL.UpdateInstallerDescription(instPath, "pathwayBTE.wxs", Version.Text);
            BuilderBL.UpdateReadme(instPath, "ReadMePw.rtf", ProdName, Version.Text);
            Close();
            Environment.Exit(0);
        }

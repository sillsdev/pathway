...
\hangindent= 12pt
\hangafter=1
\headwordggoTeluINentryletDatadicBody{అక్కల్} \spanenpronunciationggofonipaxemicpronunciationsentryletDatadicBody{[}\spanggofonipaxemicpronunciationggofonipaxemicpronunciationsentryletDatadicBody{akkal}\spanenpronunciationggofonipaxemicpronunciationsentryletDatadicBody{]} 
 \end{multicols}
\end{document}

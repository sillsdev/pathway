        ...
        public void WriteError(string className, string attributeName, string errorMessage, string attributeValue)
        {
            if (showError)
            {
                if (!errorWritten)
                {
                    ...
                    fileWriter.WriteLine("<H1> " + ProductName + " - Errors </H1>");
                    fileWriter.WriteLine("<table border=2>");
                    fileWriter.WriteLine("<tr> <td class=\"color_blue\">Class Name</td> <td class=\"color_blue\">Propery Name</td> <td class=\"color_blue\">Value</td> <td class=\"color_blue\">Error Description</td> </tr>");

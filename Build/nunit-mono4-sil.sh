...
mono ../packages/NUnit.Runners.Net4.2.6.4/tools/nunit-console-x86.exe ../output/Debug/Export/Test.dll -xml=Test-Result.xml -labels -out=Test-Output.txt -exclude=SkipOnTeamCity\;SkipOnLinux ${1} >Test-Log.txt

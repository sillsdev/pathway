...
namespace SIL.PublishingSolution
{
    public partial class PrintVia : Form, IExportContents, IScriptureContents
    {
        ...
        private void PrintVia_Load(object sender, EventArgs e)
        {
            ...
            Common.PathwayHelpSetup(File.Exists(Param.FromProg("ScriptureStyleSettings.xml")), Param.FromProg("Help"));
        ...
        private void LoadLayouts()
        {
            ...
            XmlNodeList stylenames = Param.GetItems("//styles/" + _media + "/style");
        ...
        {
            string BackendsPath = Path.Combine(Common.GetPSApplicationPath(), "BackEnds");
        ...
        private void BtnBrwsLayout_Click(object sender, EventArgs e)
        {
            ...
            PreviewPrintVia previewPrintVia = new PreviewPrintVia(_media, stylenamePath);

...
document('http://xobjex.com/service/date.xsl')/date/utc/*"/>
        ...
        <xsl:element name="metadata">
			...
			<xsl:element name="dc-metadata">
				...
				<!-- The following block is generated by Pathway during the Logos Alpha export. Do not modify this block directly. -->
				<!-- Generated XSLT nodes -->
				<!-- END Generated XSLT nodes -->
				<xsl:element name="dc-element">
					<xsl:attribute name="xml:lang">
						<!-- xsl:value-of select="$lang"/ -->

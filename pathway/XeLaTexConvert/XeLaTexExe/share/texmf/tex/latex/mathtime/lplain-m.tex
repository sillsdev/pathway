...
% *********************************************************************
%	 Modified to use MathTime + Times + Helvetica + Courier
% You may also need to do something about hard-wired accent positions.
% This depends on what encoding you are using --- see `stanacce.tex'
% *********************************************************************
...
% NOTE: hard-wired accents set up for TeX text encoding ... 
...
\def\fmtname{lplain-lb}\def\fmtversion{2.09-March 25, 1992}

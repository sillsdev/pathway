// --------------------------------------------------------------------------------------------
// <copyright file="SettingBl.cs" from='2009' to='2014' company='SIL International'>
...
namespace SIL.PublishingSolution
{
    ...
    public class SettingBl
    {
        ...
        public string _locUser = GetRegionCode();
        #endregion
        ...
        public static string GetRegionCode()
        {
          ...
          try
	  {
		regCode = System.Globalization.RegionInfo.CurrentRegion.TwoLetterISORegionName;
	  }
         catch 
          {}
         return regCode;
